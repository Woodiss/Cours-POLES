...
let prenomSaisie = prompt("saisir ton prénom");
let nomSaisie = prompt("saisir ton nom");

console.log(direBonjour(prenomSaisie, nomSaisie));
...
function calculer(chiffre1, operateur, chiffre2) {
  switch (operateur) {
    case "+":
