...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['title']) && (!empty($_POST['description'])) && (!empty($_POST['price'])) && (!empty($_POST['city'])) && (!empty($_POST['postal_code'])) && (!empty($_FILES['image']))) {
        ...
        $insertProduct = "INSERT INTO `produit`(`title`, `description`, `image`, `price`, `city`, `postal_code`,`date_add`) VALUES ('$title','$description','$image_nom','$price','$city','$postal_code','$date')";
    ...
    <div class="container-fluid col-6" style="margin-top: 100px;">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="postal_code" placeholder="Enter postal code" name="postal_code" required>
            </div>
