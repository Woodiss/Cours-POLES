...
if (!empty($_POST)) {
    ...
    $sqlNewProduct = "INSERT INTO `product`(`title`, `price`, `description`, `image`, `stock`, `id_user`, `discount`, `id_category`) VALUES ('$title','$price','$desc','$image_nom','$stock','$idUser','$discount', '$category')";

    mysqli_query($db_connect, $sqlNewProduct);
                ...
                <div class="container-fluid mt-5" style="margin-top: 100px;">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="category" placeholder="Enter category" name="category" required>
                        </div>
